return {
    image = "/home/cocoa6874/Downloads/saya-first.jpg",
    ...
    on_primary = "0xff561e18",

    on_primary_container = "0xffffdad5",

    on_primary_fixed = "0xff3b0906",

    on_primary_fixed_variant = "0xff73342c",
